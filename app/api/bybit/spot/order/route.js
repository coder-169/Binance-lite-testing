...
export async function POST(req, res) {
    ...
    try {
        ...
        const type = 'market'; // type of order (limit order)
        const side = 'sell'; // order side (buy or sell)
        const amount = 0.68; // amount of cryptocurrency to buy
        // const price = 80000; // price at which to buy
        const order = await exchange.createOrder(symbol, type, side, amount, { category: 'spot' });
